...
\begin{figure}[t]
\centering
\subfigure{\centering \includegraphics[width=0.4\textwidth]{figures/results/obLabel/changeMem_numObs.png}}
...
\begin{figure}[h]
\centering
\subfigure{\centering \includegraphics[width=0.4\textwidth]{figures/results/obLabel/interaction_2.png}}
